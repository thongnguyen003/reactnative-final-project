...
const styles = StyleSheet.create({
  ...
  statusRow:{ flexDirection:'row' , flexWrap:'wrap', gap:8, marginVertical:10 },
  statusBtn:{ paddingVertical:8, paddingHorizontal:14, borderRadius:20, backgroundColor:'#eee' },
  ...
  card:{ flexDirection:'row', backgroundColor:'white', padding:12, borderRadius:14, marginBottom:12, elevation:3 },
  image:{ width:70, height:70, borderRadius:10 },
  name:{ fontSize:16, fontWeight:'700' },
  qty:{ marginTop:4, color:'#666' },
  total:{ marginTop:6, fontWeight:'700', color:COLORS.PRIMARY },
  statusLabel:{ fontWeight:'700', color:COLORS.PRICE, alignSelf:'center' },
